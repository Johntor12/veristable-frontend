  ...
  useEffect(() => {
    ...
    if (assetType === "RealEstate") {
      ...
      d = {
        ...
        contractInfo:
          "The Carbon Credit Token contract is an ERC20-compliant digital asset that represents carbon credits.",
      ...
      d = {
        ...
        contractInfo:
          "The Commodities Token contract is an ERC20-compliant tokenization of physical commodities such as gold, oil, etc.",
