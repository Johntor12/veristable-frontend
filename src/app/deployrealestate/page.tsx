  ...
  return (
    <div className="min-h-screen bg-white pt-[6vw] px-4 lg:px-0 font-jakarta ml-[1vw]">
      <div className="w-[90%] mx-auto py-12">
        ...
        {/* Back Button */}
        <div className="flex items-center gap-[0.83vw] mb-[4.5vw] cursor-pointer" onClick={() => router.back()}>
        ...
        <div className="w-[85.33vw] border border-[#D5D7DA] rounded-xl p-[2vw]">
          ...
          <div className="w-[73.05vw] border border-[#D5D7DA] rounded-lg p-[2vw]">
            ...
            <h3 className="text-[1.25vw] text-[#000000] font-bold mb-[1.5vw]">Contract Metadata</h3>
            <div className="w-[68.4vw] h-[1px] bg-[#F5F5F5] mb-[2vw]" />

            <div className="flex gap-[2vw]">
              {/* Upload Image */}
              <div className="flex flex-col">
                <label className="text-[#000000] font-medium text-[1.11vw] mb-[0.7vw]">Image</label>
                <label className="w-[15vw] h-[14.79vw] border border-[#D5D7DA] rounded-lg flex flex-col justify-center items-center cursor-pointer">
                  {selectedImage ? (
                    ...
                    <>
                      <Image src="/icons/upload.png" alt="Upload" width={30} height={30} />
                      <p className="text-[#717680] text-[0.83vw] font-normal mt-[0.5vw]">Upload File</p>
                    </>
                  )}
                  <input
                    type="file"
              ...
              <div className="flex-1 flex flex-col gap-[2vw]">
                <div className="flex gap-[2vw]">
                  ...
                  {/* Symbol */}
                  <div className="flex flex-col">
                    <label className="text-[#000000] font-medium text-[1.11vw] mb-[0.7vw]">Symbol</label>
                    <input
                      type="text"
                      placeholder="Type here"
                ...
                {/* Description */}
                <div className="flex flex-col">
                  <label className="text-[#000000] font-medium text-[1.11vw] mb-[0.7vw]">Description</label>
                  <textarea
                    placeholder="Type here"
          ...
          <div className="w-[73.05vw] border border-[#D5D7DA] rounded-lg p-[2vw] mt-[2vw]">
            <h3 className="text-[1.25vw] text-[#000000] font-bold mb-[1vw]">Primary Sales</h3>
          ...
          <div className="w-[73.05vw] border border-[#D5D7DA] rounded-lg p-[2vw] mt-[2vw]">
            <h3 className="text-[1.25vw] text-[#000000] font-bold mb-[1vw]">Platform Fees</h3>
            <div className="w-[68.4vw] h-[1px] bg-[#F5F5F5] mb-[1.5vw]" />
            <p className="text-[1.11vw] text-[#535862] font-normal leading-relaxed">
              A 2% fee on primary sales supports our mission to make real-world assets accessible onchain — funding open infrastructure, ongoing development, and verification integrity.{" "}
          ...
          {/* Card 4: Gasless */}
          <div className="w-[73.05vw] border border-[#D5D7DA] rounded-lg p-[2vw] mt-[2vw]">
            <h3 className="text-[1.25vw] text-[#000000] font-bold mb-[1vw]">Gasless</h3>
            <div className="w-[68.4vw] h-[1px] bg-[#F5F5F5] mb-[1.5vw]" />
            <div className="flex flex-col gap-[0.7vw]">
              <label className="text-[1.11vw] text-[#000000] font-medium">
          ...
          <div className="w-[73.05vw] border border-[#D5D7DA] rounded-lg p-[2vw] mt-[2vw]">
            <h3 className="text-[1.25vw] text-[#000000] font-bold mb-[1vw]">Add to Project</h3>
            <p className="text-[0.97vw] text-[#535862] font-medium mb-[1.5vw]">
              Save the deployed contract in a project’s contract list on MyRWA and VeriStable dashboard.
            </p>
            <div className="w-[68.4vw] h-[1px] bg-[#F5F5F5] mb-[2vw]" />
            <div className="flex items-center gap-[2vw]">
              {/* Team */}
              <div className="flex flex-col">
                <label className="text-[1.11vw] text-[#000000] font-medium mb-[0.7vw]">Team</label>
                <Dropdown options={teams} placeholder="Select Team" width="w-[16.18vw]" height="h-[2.64vw]" />
              </div>
              <span className="text-[1.25vw] font-semibold">/</span>
              {/* Project */}
              <div className="flex flex-col">
                <label className="text-[1.11vw] text-[#000000] font-medium mb-[0.7vw]">Project</label>
                <Dropdown options={projects} placeholder="Select Project" width="w-[16.18vw]" height="h-[2.64vw]" />
              </div>
            </div>
          </div>
          ...
          <div className="w-[73.05vw] border border-[#D5D7DA] rounded-lg p-[2vw] mt-[2vw]">
            ...
            <div className="flex flex-col gap-[0.7vw]">
              ...
              <p className="text-[1.11vw] text-[#535862] font-medium">Select a network to deploy this contract on.</p>
              <Dropdown options={chains} placeholder="Select Chain" width="w-[54vw]" height="h-[2.64vw]" />
            </div>
          </div>
